...
class User(ABC):
    def __init__(self, name, email, nid) -> None:
        self.name = name
@@ -16,9 +32,9 @@ def display_profile(self):
...
@@ -32,12 +48,17 @@ def load_cash(self, amount):
...
class Driver(User):
    def __init__(self, name, email, nid, current_location) -> None:
@@ -73,6 +94,8 @@ def end_ride(self, rider, amount):
...
@@ -81,13 +104,60 @@ def __init__(self, rider, end_location) -> None:
